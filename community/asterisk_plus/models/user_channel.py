...
class UserChannel(models.Model):
    ...
    @api.onchange('sip_transport')
    def set_auto_answer_header(self):
        if not self.auto_answer_header and self.sip_transport == 'webrtc-user':
            self.auto_answer_header = 'Answer-Mode: Auto'
